...
std::ostream &operator << (std::ostream &out, Form const &form) {
	...
	out << "Form name: " << RED << form.getName() << ENDC << std::endl;
	out << "Form is " << PURPLE << ((form.isSigned()) ? "Signed" : "Unsigned") << ENDC << std::endl;
	out << "Sign grade: " << SKYBLUE << form.getSignGrade() << ENDC << std::endl;
